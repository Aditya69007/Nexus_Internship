      ...
      <div className="w-full max-w-3xl space-y-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <motion.div 
            ...
            className="mt-6 flex flex-col flex-wrap justify-center gap-4">
            {musicPlatformLinks.map((link) => (
              <button
                key={link.musicPlatform + link.url}
                className="flex items-center p-2 border border-gray-300 rounded-full shadow-md hover:bg-gray-100 transition hover:scale-110"
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {musicVideos.map((video) => (
                    <motion.div key={video.videoId} whileHover={{scale:1.05}}>
                        <Card
                          //key={video.videoId}
        ...
        <ScrollArea>
          ...
          <div id="performances" className="mt-8">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <motion.h2 variants={fadeIn("left",0.3)} initial="hidden" whileInView={"show"}  className="text-3xl font-bold text-center text-white mb-6">Performances</motion.h2>

              {performances.map((perf) => (
<motion.div whileHover={{scale:1.05}}key={perf.performanceId}>
          ...
          <div id="songsSale">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <motion.h2 variants={fadeIn("left",0.3)} initial="hidden" whileInView={"show"}  className="text-3xl font-bold text-center text-white mb-6">Songs for Sale</motion.h2>
          ...
          <div id="merchandise">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <motion.h2 variants={fadeIn("left",0.3)} initial="hidden" whileInView={"show"} className="text-3xl font-bold text-center text-white mb-6">Merchandise</motion.h2>
          ...
          <div id="messages">
            {fanMessages && (
              <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
                <motion.h2 variants={fadeIn("left",0.3)} initial="hidden" whileInView={"show"}  className="text-3xl font-bold text-center text-white mb-6">Fan Messages</motion.h2>
          ...
          <div id="support">
            {supportPage && (
              <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
                <motion.h2 variants={fadeIn("left",0.3)} initial="hidden" whileInView={"show"}  className="text-3xl font-bold text-center text-white mb-6">Support Me</motion.h2>
                <motion.div whileHover={{scale:1.05}}>
                <Card className="mb-4">
                  <CardHeader>
